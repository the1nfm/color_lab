...
export function cmykToLab(c, m, y, k) {
    const ret = wasm.cmykToLab(c, m, y, k);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function labToCmyk(l, a, b) {
    const ret = wasm.labToCmyk(l, a, b);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
